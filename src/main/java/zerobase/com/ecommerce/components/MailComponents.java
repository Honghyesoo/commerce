...
public class MailComponents {
    ...
    public boolean sendMail(String mail, String subject, String text) {
        ...
        MimeMessagePreparator msg = mimeMessage -> {
            ...
            mimeMessageHelper.setFrom("ghdgptn13@gmail.com", "commerce");
    ...
    public String getEmailAuthTemplate(String userId, String emailAuthKey) {
        String authUrl = "http://localhost:8080/user/email-auth?userId=" + userId + "&key=" + emailAuthKey;

        return "<div style='margin:100px;'>" +
                "<h1>Commerce 가입을 환영합니다!</h1>" +
                "<br/>" +
